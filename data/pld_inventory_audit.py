...
filtered to PLD-equippable items. Output goes to pld_inventory_audit.txt
next to this script.
"""
import json
import re
...
OUTPUT     = Path(r"C:\Users\Jason\Desktop\Windower\addons\GSUI\data\pld_inventory_audit.txt")
